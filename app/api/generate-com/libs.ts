...
Your comment must bring real value to the conversation — by contributing a complementary insight, a relevant angle, or a piece of useful information related to the post.
...
Do not agree or rephrase. Just add something useful, related to the post. Your role is to enrich the discussion, not echo it.
...
6. You MUST build comments that add real value to the conversation. Examples: complementary insight, thoughtful question, or relevant information related to the post.
