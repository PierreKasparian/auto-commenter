...
export default async function YourTone() {
  ...
  return (
    <div className="w-full mx-auto bg-white rounded-xl shadow-sm border overflow-hidden">
      <div className="p-6 border-b">
        <h2 className="text-lg font-semibold text-black">Your comment tone</h2>
        <p className="text-muted-foreground">
          Add examples of comments you&apos;ve made to help our AI match your
          tone and style
        </p>
      </div>
      <div className="">
      ...
      <div className="p-6">
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-500 text-sm mb-4">
            ...
            Delete examples if you don&apos;t want the IA to take example on
            them.
          </p>
